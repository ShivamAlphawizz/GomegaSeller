...
import 'package:eshopmultivendor/Model/OrderStatusModel.dart';
...
class _OrderListState extends State<OrderList> with TickerProviderStateMixin {
  ...
  orderStatusFunction(String id,String status)async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse(baseUrl +'status_change'));
    ...
    if (response.statusCode == 200) {
      ...
      final jsonResponse = OrderStatusModel.fromJson(json.decode(finalResponse));
      print("checking response here ${jsonResponse.message}");
    ...
    return model.itemList!.isNotEmpty ? Card(
      ...
      child: InkWell(
        ...
        child: Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    //     ),
                    //   ),
                    //   child: model.itemList![0].activeStatus == "shipped" ? Text("Served",
                    //     style: TextStyle(color: white)) : model.itemList![0].activeStatus == "delivered" ? Text("Served",
                    //       style: TextStyle(color: white)) : Text(
         ...
         //      ),
         //      child: Text("Accepted",style: TextStyle(color: Colors.white,fontWeight:FontWeight.w500,fontSize: 16),),
         //    ),
         //  ): model.status == "2" ? Container(
         //    width:MediaQuery.of(context).size.width,
         //    height: 45,
         //    alignment: Alignment.center,
         //    decoration:BoxDecoration(
         ...
         //        borderRadius: BorderRadius.circular(6)
         //    ),
         //    child: Text("Rejected",style: TextStyle(color: Colors.white,fontWeight:FontWeight.w500,fontSize: 16),),
         //  )  :    Container(
         //        child: Row(
         //          crossAxisAlignment: CrossAxisAlignment.start,
         ...
         //              child: InkWell(
         //                onTap: (){
         //                  orderStatusFunction(model.id.toString(),"2");
         //                },
         //                child: Container(
         //                  width:MediaQuery.of(context).size.width,
         //                  height: 45,
         ...
         //                      borderRadius: BorderRadius.circular(6)
         //                  ),
         //                  child: Text("Reject",style: TextStyle(color: Colors.white,fontWeight:FontWeight.w500,fontSize: 16),),
         //                ),
         //              ),
         //            ),
         //            SizedBox(width: 10,),
         ...
         //              child: InkWell(
         //                onTap: (){
         //                  orderStatusFunction(model.id.toString(),"1");
         //                },
         //                child: Container(
         //                  width:MediaQuery.of(context).size.width,
         //                  height: 45,
         ...
         //                    borderRadius: BorderRadius.circular(6)
         //                  ),
         //                  child: Text("Accept",style: TextStyle(color: Colors.white,fontWeight:FontWeight.w500,fontSize: 16),),
         //                ),
         //              ),
         //            ),
         //          ],
        ...
        onTap: () async {
          ...
          print("${model.id}");
          List splitData = model.itemList![0].estimateTime!.split(':');
          if(model.itemList![0].estimateTime != null && model.itemList![0].estimateTime != 0) {
            if(splitData[0].toString() != "") {
              int updatedTime = 1;
             var result =  await Navigator.push(
                ...
                MaterialPageRoute(
                  ...
                  OrderDetail(
                    minute: updatedTime,
                    // model.itemList![0].estimateTime.toString(),
                       model: orderList[index],
                    id: model.id,
                  ),
                ),
