...
import 'package:eshopmultivendor/Screen/table.dart';
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              _getDrawerItem(3, getTranslated(context, "TABLE")!,
                  Icons.table_bar),
              _getDrawerItem(12, getTranslated(context, "WALLETHISTORY")!,
                  Icons.wallet),
              Divider(),
    ...
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          } else if (title == getTranslated(context, "TABLE")!) {
            // setState(
            //   () {
            //     curDrwSel = index;
            //   },
